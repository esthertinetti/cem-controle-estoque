            ...
            <div className="flex-col lg:flex-row flex lg:justify-between relative justify-center xl:max-w-[80%] w-full p-2 items-center">
                ...
                <div className="p-6 md:p-12 bg-gray-100 rounded-[20px] shadow-md m-4 flex flex-col justify-between max-w-lg w-full h-full transition-all text-left">
                    ...
                    <form className="w-full" action="" method="get">
                        ...
                        <Button className="mb-10 flex flex-row items-center p-2 w-full h-14 bg-[#0A2186] hover:bg-[#151D48] shadow-[0px_3px_3px_rgba(55,69,87,0.1)] rounded-xl font-poppins font-semibold text-lg leading-[27px] text-white text-center" type="submit">
                            Entrar
                        </Button>
                    </form>
                </div>
